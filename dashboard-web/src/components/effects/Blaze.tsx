// Ported from the user's own CanvasUI-licensed component (saigon.exe project,
// components/canvasui/Blaze.tsx) — pure React + WebGL2, no external deps.
// Reused verbatim aside from stripping the Next.js "use client" directive
// (meaningless outside Next.js) and importing CSSProperties explicitly,
// matching this project's existing import style (see morphing-tabs.tsx).
import {
  useEffect,
  useRef,
  useState,
